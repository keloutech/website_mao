...
function digital_download_edd_meta(){
	...
	$download_tags = get_the_term_list( get_the_ID(), 'download_tag', '', esc_html_x(' ', 'list item separator', 'digital-download' ), '' );

	// Get the download categories
	$download_cats = get_the_term_list( get_the_ID(), 'download_category', '', esc_html_x(' ', 'list item separator', 'digital-download' ), '' );
...
function digital_download_download_image(){ 
	...
	<div class="download-image-overlay">        
		<div class="download-cart-view">
			...
			<span data-id="<?php the_ID(); ?>" class="download-cart-btn" title="<?php esc_attr_e( 'Cart', 'digital-download' ); ?>"></span>            
		</div>		
	</div>
	<?php
}
...
add_action( 'edd_downloads_list_before', 'digital_download_edd_download_list_before' ); 
