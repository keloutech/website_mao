...
if ( ! function_exists( 'digital_download_customizer_theme_info' ) ) :
	...
	function digital_download_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'digital-download' ), esc_url( __( 'https://demo.raratheme.com/digital-download/', 'digital-download' ) ), esc_html__( 'Click here.', 'digital-download' ) );

	    $theme_info .= '</p><p>';

	    /* translators: 1: string, 2: documentation url, 3: string */
	    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'digital-download' ), esc_url( 'https://raratheme.com/documentation/digital-download/' ), esc_html__( 'Click here.', 'digital-download' ) );
	...
	$manager->add_section(
		new Digital_Download_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => 'https://raratheme.com/wordpress-themes/digital-download-pro/'
			)
		)
	);
}
