...
?>
<div class="portfolio-single-page style-4">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="pf-title h2 text-center"><?php the_title();?></h1>
            <div class="portfolio-meta-data inline-meta text-center">
                <?php
                if(!empty($client)){
            ...
            <div class="portfolio-social-links text-center">
                <label><?php esc_html_e('Share with', 'optima')?></label>
