    ...
    $(function(){
        ...
        $document
            ...
            .on( 'la_admin_menu_event:update_dependency', '.la-element-menu-type select', function(e){
                ...
                if(_select.val() == 'wide'){
                    $('.la-element-popup-columns,.la-element-popup-max-width,.la-element-popup-background', $li).addClass('show');
                    ...
                    $('.la-element-popup-columns,.la-element-popup-max-width,.la-element-popup-background', $li).removeClass('show');
