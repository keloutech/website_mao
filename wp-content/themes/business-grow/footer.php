	...
	<footer id="colophon" class="site-footer bottom-footer" role="contentinfo">
		<div class="container">
			<div class="copyright">
				...
				<p><?php echo wp_kses_post($copyright); ?><a href="" target="_blank" style="color: #F88C00;"><?php //printf( esc_html__( 'Ample Themes %s', 'business-grow' ));?></a> |
					<a href="<?php echo esc_url( __( 'https://www.amplethemes.com/', 'business-grow' ) ); ?>"
                    ><?php
						/* translators: %s: CMS name, i.e. WordPress. */
						printf( esc_html__( ' Developed & Design by AmpleThemes %s', 'business-grow' ), '' );
						?></a>	</p>
