 ...
 */
add_action( 'wp_enqueue_scripts', 'business_grow_enqueue_styles' );
function business_grow_enqueue_styles() {
...
add_action('wp_enqueue_scripts', 'business_grow_script_fix', 100);
function business_grow_script_fix()
{
    wp_dequeue_script('business-grow-main');
    wp_enqueue_script('business-grow-main', get_stylesheet_directory_uri().'/assets/js/main.js', array('jquery'));
}
