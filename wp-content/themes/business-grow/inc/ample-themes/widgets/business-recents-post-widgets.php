...
if (!class_exists('Business_Recent_Post_Widget')) {
    class Business_Recent_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Latest Blogs', 'business-grow'),
                'sub-title' => '',
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('Business Recent Post Widget', 'business-grow'),
                array('description' => esc_html__('Business Recent Post Section', 'business-grow'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title')); ?>">
                    <?php esc_html_e('Title', 'business-grow'); ?>
                </label><br/>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('cat_id')); ?>">
                    <?php esc_html_e('Select Category', 'business-grow'); ?>
                </label><br/>
                <?php
                $business_con_dropown_cat = array(
                    'show_option_none' => esc_html__('From Recent Posts', 'business-grow'),
                    'orderby' => 'name',
                    'order' => 'asc',
                    'show_count' => 1,
                    'hide_empty' => 1,
                                                ...
                                                <div class="blog-details">
                                                    <header class="entry-header">
                                                        ...
                                                        <a href="<?php comments_link(); ?>" rel="">
                                                            ...
                                                            <time class="entry-date published" datetime=""><?php  esc_html_e('Leave a comment','business-grow')?></time>
                                                        </a>
                                                        </span>
                                                        </div>
                                                        <div class="entry-content">
                                                            <p><?php echo esc_html(wp_trim_words(get_the_content(), 20)); ?></p>
                                                            <a href="<?php the_permalink();?>" class="article-readmore"><?php esc_html_e('Continue Reading', 'business-grow'); ?><span class="arrow-continue"><?php echo esc_html('→','business-grow');?></span></a>
