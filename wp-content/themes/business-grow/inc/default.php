...
if ( !function_exists('ample_business_get_default_theme_options' ) ) :
    ...
    function ample_business_get_default_theme_options()
    {
        ...
        $default['ample_business_slider_get_started_txt'] = esc_html__('Get Started!', 'business-grow');
        $default['ample_business_slider_get_started_link'] = '#';

        // footer copyright.
        $default['ample_business_copyright'] = esc_html__('Copyright Text', 'business-grow');

        // Home Page Top header Info.
        $default['ample_business_top_header_section'] = 'hide';
        $default['ample_business_notice_title']= esc_html__('Notice', 'business-grow');
        $default['ample_business_news_cat_id']='';
        $default['ample_business_no_of_news']=5;
        $default['ample_business_social_link_hide_option'] = 1;

        $default['ample_business_button']=esc_html__('Contact Us', 'business-grow');
        $default['ample_business_apply_button_link']='';

        // Blog.
        $default['ample_business_sidebar_layout_option'] = 'right-sidebar';
        $default['ample_business_blog_title_option'] = esc_html__('Latest Blog', 'business-grow');
        ...
        // Color Option.
        $default['ample_business_primary_color'] = '#3a6ee7';

        $default['ample_business_top_header_background_color'] = '#3a6ee7';
        ...
        $default['ample_business_post_search_placeholder_option'] = esc_html__('Search', 'business-grow');
