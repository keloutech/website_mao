        ...
        <div class="single-review">
            ...
            <div class="post-content">
                ...
                <p class="post-short-desc"> 
                    ...
                    wp_link_pages( array(
                        'before' => '<div class="page-links">' . esc_html__( 'Pages:','business-grow' ),
                        'after'  => '</div>',
                    ) );
                ...
                <a href="<?php the_permalink();?>" class="continue-link"><?php esc_html_e('Continue Reading', 'business-grow'); ?></a>
            </div>
        </div><!-- /.single-review -->
    </div>
