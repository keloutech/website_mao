...
?>
	<a class="wishlist-contents"  href="<?php echo esc_url(home_url( '/wish-list')); ?>" title="<?php esc_attr_e( 'View your whishlist', 'ecommerce-star' ); ?>">
...
if($ecommerce_star_option['header_woocommerce_ajax_search']){
	?>
