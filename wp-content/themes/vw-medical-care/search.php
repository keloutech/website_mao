...
<div class="container">
    ...
    <?php
        $theme_lay = get_theme_mod( 'vw_medical_care_theme_options','Right Sidebar');
        if($theme_lay == 'Left Sidebar'){ ?>
            <div class="row m-0">
                ...
                <div id="our-services" class="services col-lg-8 col-md-8">
                    ...
                    printf( esc_html__( 'Results For: %s','vw-medical-care'), esc_html( get_search_query() ) ); ?></h1> 
                    <?php if ( have_posts() ) :
                        /* Start the Loop */
                    ...
                    <div class="navigation">
                        <?php
                            ...
                            the_posts_pagination( array(
                                'prev_text'          => __( 'Previous page', 'vw-medical-care' ),
                                'next_text'          => __( 'Next page', 'vw-medical-care' ),
                                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-medical-care' ) . ' </span>',
                            ) );
                        ?>
