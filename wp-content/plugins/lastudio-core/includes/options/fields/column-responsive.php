 ...
 *
 */
class LaStudio_Framework_Field_column_responsive extends LaStudio_Framework_Field_Base {
        ...
        if($this->options['xlg'] || $this->options['lg'] || $this->options['md'] || $this->options['sm'] || $this->options['xs'] || $this->options['mb'] ){
	        ...
	        if($this->options['xlg']){
		        echo la_fw_add_element( array(
			        ...
			        'before'          => '<label class="la-tip" data-position="top" data-title="'. esc_attr__('Large Desktop', 'la-studio') .'"><i class="fa fa-desktop"></i></label>'
		        ) );
	        }
            ...
            if($this->options['lg']){
                echo la_fw_add_element( array(
                    ...
                    'value'           => $this->value['lg'],
                    'class'         => 'la-child-field',
                    'before'          => '<label class="la-tip" data-position="top" data-title="'.esc_attr__('Desktop', 'la-studio').'"><i class="dashicons dashicons-desktop"></i></label>'
                ) );
            }
            ...
            if($this->options['md']){
                echo la_fw_add_element( array(
                    ...
                    'value'           => $this->value['md'],
                    'class'         => 'la-child-field',
                    'before'          => '<label class="la-tip" data-position="top" data-title="'. esc_attr__('Tablet', 'la-studio') .'"><i class="dashicons dashicons-tablet" style="transform: rotate(90deg);"></i></label>'
                ) );
            }
            ...
            if($this->options['sm']){
                echo la_fw_add_element( array(
                    ...
                    'value'           => $this->value['sm'],
                    'class'         => 'la-child-field',
                    'before'          => '<label class="la-tip" data-position="top" data-title="'. esc_attr__('Tablet Portrait', 'la-studio') .'"><i class="dashicons dashicons-tablet"></i></label>'
                ) );
            }
            ...
            if($this->options['xs']){
                echo la_fw_add_element( array(
                    ...
                    'value'           => $this->value['xs'],
                    'class'         => 'la-child-field',
                    'before'          => '<label class="la-tip" data-position="top" data-title="'. esc_attr__('Mobile Landscape', 'la-studio') .'"><i class="dashicons dashicons-smartphone" style="transform: rotate(90deg);"></i></label>'
                ) );
            }
            ...
            if($this->options['mb']){
                echo la_fw_add_element( array(
                    ...
                    'value'           => $this->value['mb'],
                    'class'         => 'la-child-field',
                    'before'          => '<label class="la-tip" data-position="top" data-title="'. esc_attr__('Mobile', 'la-studio') .'"><i class="dashicons dashicons-smartphone"></i></label>'
                ) );
            }
