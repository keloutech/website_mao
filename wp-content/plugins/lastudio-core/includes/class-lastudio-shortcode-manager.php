...
class LaStudio_Shortcode_Manager {
    ...
    public function media_shortcode_button( $editor_id ) {
        ...
        if( ! in_array( $post_type, $this->exclude_post_types ) ) {
            echo '<a href="#" class="button button-primary la-shortcode" data-editor-id="'. $editor_id .'">'. __( 'Add Shortcode', 'la-studio' ) .'</a>';
        }
    ...
    public function shortcode_dialog() {
        ?>
        <div id="la-shortcode-dialog" class="la-dialog" title="<?php _e( 'Add Shortcode', 'la-studio' ); ?>">
            <div class="la-dialog-header">
                <select class="<?php echo ( is_rtl() ) ? 'chosen-rtl ' : ''; ?>la-dialog-select" data-placeholder="<?php _e( 'Select a shortcode', 'la-studio' ); ?>">
                    <option value=""></option>
                    <?php
            ...
            <div class="la-insert-button hidden">
                <a href="#" class="button button-primary la-dialog-insert"><?php _e( 'Insert Shortcode', 'la-studio' ); ?></a>
            </div>
        </div>
        <?php
    }
