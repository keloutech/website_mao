...
class LaStudio_Swatch_Widget extends WC_Widget{
    /**
     * Constructor.
     */
    public function __construct() {
        $this->widget_cssclass    = 'woocommerce widget_layered_nav';
        $this->widget_description = __( 'Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.', 'la-studio' );
        $this->widget_id          = 'woocommerce_layered_nav';
        $this->widget_name        = __( 'WooCommerce Layered Nav', 'la-studio' );
        parent::__construct();
    }
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title' => array(
                'type'  => 'text',
                'std'   => __( 'Filter by', 'la-studio' ),
                'label' => __( 'Title', 'la-studio' )
            ),
            'attribute' => array(
                'type'    => 'select',
                'std'     => '',
                'label'   => __( 'Attribute', 'la-studio' ),
                'options' => $attribute_array
            ),
            'display_type' => array(
                'type'    => 'select',
                'std'     => 'list',
                'label'   => __( 'Display type', 'la-studio' ),
                'options' => array(
                    'swatches'     => __( 'Swatches', 'la-studio' ),
                    'list'     => __( 'List', 'la-studio' ),
                    'dropdown' => __( 'Dropdown', 'la-studio' )
                )
            ),
            'query_type' => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => __( 'Query type', 'la-studio' ),
                'options' => array(
                    'and' => __( 'AND', 'la-studio' ),
                    'or'  => __( 'OR', 'la-studio' )
                )
            ),
        );
    ...
    protected function layered_nav_dropdown( $terms, $taxonomy, $query_type ) {
        ...
        if ( $taxonomy !== $this->get_current_taxonomy() ) {
            ...
            echo '<option value="">' . sprintf( __( 'Any %s', 'la-studio' ), wc_attribute_label( $taxonomy ) ) . '</option>';
