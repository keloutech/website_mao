...
$shortcode_params = array(
    ...
    array(
        ...
        'value' => array(
            ...
            __('With Countdown','la-studio') => 'countdown',
            __('With Countdown 2','la-studio') => 'countdown-2',
            __('With Countdown 3','la-studio') => 'countdown-3',
            __('With Countdown 4','la-studio') => 'countdown-4'
        ),
        'dependency' => array(
            'element'   => 'layout',
            'value'     => 'list'
...
return apply_filters(
    ...
    array(
        'name'			=> __('Sale products', 'la-studio'),
        'base'			=> 'sale_products',
        'icon'          => 'icon-wpb-woocommerce',
        'category'  	=> __('La Studio', 'la-studio'),
        'description' 	=> __('List all products on sale','la-studio'),
